...
class videoFunctions:
    ...
    def  makeVideo(self,id,fk,duration=2,titlebar=False,reverse=False):
        ...
        def add_text_with_shadow(text_list,path_list, font_path=r'C:\Users\habib92\Desktop\tobeChanged\video-creator-api-django\webcreatorApp\functionality\static\fonts\RussoOne-Regular.ttf', font_size=45, text_position=(180, 420), text_color=(255, 255, 0), shadow_color=(0, 0, 0), shadow_offset=(4,4)):
            count=0
