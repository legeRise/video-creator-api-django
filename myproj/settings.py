...
AWS_STORAGE_BUCKET_NAME = os.environ.get('AWS_STORAGE_BUCKET_NAME') #'videoapidjango'  # replace your bucket name
AWS_S3_REGION_NAME = os.environ.get('AWS_S3_REGION_NAME') #'eu-north-1'   # replace region name
